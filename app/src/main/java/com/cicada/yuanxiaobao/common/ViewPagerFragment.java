...
public class ViewPagerFragment extends Fragment {
     ...
     * @return
     */
    public ViewPagerFragment setIsShowCursor(boolean isShowCursor) {
    ...
    public void onStart() {
        if (aBoolean) {
            ...
            if (backGroundColor != 0)
                linearLayout.setBackgroundResource(getActivity().getResources().getColor(backGroundColor));
        }
